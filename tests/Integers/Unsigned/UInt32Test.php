...
use Nejcc\PhpDatatypes\Integers\Unsigned\UInt32;
...
class UInt32Test extends TestCase
{
    ...
    {
        $uint32a = new UInt32(4000000000);
        $uint32b = new UInt32(294967295);
    ...
    public function testSubtractionUnderflow()
    {
        ...
        $uint32a = new UInt32(1000000000);
        $uint32b = new UInt32(2000000000);
